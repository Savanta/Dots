...
/***/ function(module, exports, __webpack_require__) {
	...
	proxy.on('enabled', function (value) {
	  states.connected();
...
/***/ function(module, exports, __webpack_require__) {
	...
	chrome.runtime.onMessage.addListener(function (request, value) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _document$querySelectorAll = document.querySelectorAll('.logo i');

	var _document$querySelectorAll2 = _slicedToArray(_document$querySelectorAll, 2);

	var big = _document$querySelectorAll2[0];
	var small = _document$querySelectorAll2[1];

	var DELAY = 300;

	var smallTween = undefined,
	    bigTween = undefined;
